...
class CLSTM(nn.Module):
    def __init__(self, input_size=(64, 64), channels=7, out_channels=1, pred_len = 10, hidden_dim = [64], num_layers=1):
        ...
        self.out_channels = out_channels * pred_len
    ...
    def forward(self, xx):
        ...
        b, _, h, w = out.shape
        out = out.reshape(b, self.pred_len, -1, h, w)
...
if __name__ == "__main__": 
    ...
    model = CLSTM(input_size=(height, width), channels=7, pred_len = 10, hidden_dim = [64], num_layers=1)
    
    input_tensor = torch.randn(batch_size, time_steps, input_channels, height, width)
